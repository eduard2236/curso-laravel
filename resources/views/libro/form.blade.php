<div class="form-group row">
    <label for="titulo" class="col-lg-2 control-label requerido">Titulo</label>
    <div class="col-lg-8">
    <input type="text" name="titulo" id="titulo" class="form-control"  value="{{old('titulo', $data->titulo ?? '')}}" required/>
    </div>
</div>
<div class="form-group row">
    <label for="isbn" class="col-lg-2 control-label requerido">Isbn</label>
    <div class="col-lg-8">
      <input type="text" name="isbn" id="isbn" class="form-control"  value="{{old('isbn', $data->isbn ?? '')}}" required/>
    </div>
</div>
<div class="form-group row">
    <label for="autor" class="col-lg-2 control-label requerido">Autor</label>
    <div class="col-lg-8">
      <input type="text" name="autor" id="autor" class="form-control"  value="{{old('autor', $data->autor ?? '')}}" required/>
    </div>
</div>
<div class="form-group row">
    <label for="cantidad" class="col-lg-2 control-label requerido">Cantidad</label>
    <div class="col-lg-8">
...
<div class="form-group row">
  <label for="foto" class="col-lg-2 control-label requerido">Foto</label>
  <div class="col-lg-5">
