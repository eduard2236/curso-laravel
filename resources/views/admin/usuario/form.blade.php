...
<div class="form-group">
    <label for="usuarios" class="col-lg-3 control-label requerido">Usuario</label>
    <div class="col-lg-8">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
      <select name="rol_id[]" id="rol_id" class="form-control select2" multiple="multiple" data-placeholder=" selecione un rol" style="width: 100%;" required>
